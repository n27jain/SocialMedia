...
public class FireBasePostHandler {
    ...
    private  ArrayList<PostObject> currentUsersPosts;
    ...
    public FireBasePostHandler(String UserId) {
        currentUsersPosts = new ArrayList<PostObject>();
        ...
        selectUsersPostsDB = postsDB.child(UserId);
        selectUsersPostsDB.addValueEventListener(valueEventListener); // this should set and retrieve the id for the post
    ...
    private ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            if (currentUsersPosts.size() != lastSize) { // the posts provided changed.
                UpdatePostsAdapter();
            }
    ...
    public ArrayList<PostObject> getCurrentUsersPosts(){
        return currentUsersPosts;
    }
